...
class ScorecardsControllerTest < ActionController::TestCase
  ...
  test "should create scorecard" do
    assert_difference('Scorecard.count') do
      post :create, scorecard: { comment: @scorecard.comment, content: @scorecard.content, overall: @scorecard.overall, performance: @scorecard.performance }
    end
  ...
  test "should update scorecard" do
    patch :update, id: @scorecard, scorecard: { comment: @scorecard.comment, content: @scorecard.content, overall: @scorecard.overall, performance: @scorecard.performance }
    assert_redirected_to scorecard_path(assigns(:scorecard))
  end
